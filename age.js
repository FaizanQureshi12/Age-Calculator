...
let getTimeLeft = () => {
    ...
    console.log("enterd date: ", dateEntered.toDateString());
    ...
    console.log(`${nextBirthdayInDays} days, ${nextBirthdayInHours} hours,${nextBirthdayInMinutes} minutes 
      and ${nextBirthdayInSeconds}  seconds left in your next birthday`);
...
let yearOld = () => {
    ...
    console.log(`you are ${ageInYear} years, ${ageInMonth} month, ${ageInDay} days,
     ${ageInHour} hour, ${ageInMinute} minutes and 
              ${ageInSecond} seconds old`);

    document.querySelector("#yearOld").innerHTML = `You are ${ageInYear} years, ${ageInMonth} month,
       ${ageInDay} days, ${ageInHour} hour Old`;

    // My Code
    // let today = new Date()
    // console.log("today",today.getFullYear())

    // let input = document.querySelector('#userin').value
    // let now = new Date(input)
    // console.log('now',now.getFullYear())

    // let min = +today - +now
    // let days = Math.floor(min/86400000)
    // let months = Math.floor((min/86400000)/30)
    // let year = Math.floor(((min/86400000)/30)/12)

    // document.querySelector('#days').innerText = `${days} Days`;
    // document.querySelector('#month').innerText = `${months} months`;
    // document.querySelector('#year').innerText = `${year} years`;
}
